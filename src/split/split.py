...
# Declare constant paths to save module results
...
def aware_patient_split(features_vector, drop_cols) -> tuple:
    ...
    # Perform patient_id aware Group Shuffle Split
    ...
    # Remove excluded columns from features vector
    ...
    # Check if every patient_id is separated into two separate DataFrame
...
def aware_patient_split_stratified_kfold(features_vector, drop_cols) -> tuple:
    ...
    It is version with balanced cases
    """
